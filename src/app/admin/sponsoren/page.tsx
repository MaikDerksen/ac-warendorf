    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Diese Seite dient zur Verwaltung der Sponsoren. Die Bearbeitungsfunktionen werden in einem zukünftigen Schritt implementiert.
            Aktuell werden die Sponsorendaten aus der Datei <code>src/data/sponsoren/sponsors.csv</code> geladen.
          </CardDescription>
        </CardHeader>
        <CardContent>
