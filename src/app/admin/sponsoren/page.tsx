    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Hier können Sie die aktuellen Sponsorendaten herunterladen oder eine neue Version hochladen (Upload-Funktion in Entwicklung).
      ...
      <Card>
        <CardHeader>
          <CardTitle>Sponsorendaten Hochladen</CardTitle>
          <CardDescription>
            Laden Sie eine neue <code>sponsors.csv</code> Datei hoch, um die Sponsoreninformationen zu aktualisieren.
