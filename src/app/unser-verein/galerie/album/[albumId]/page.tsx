...
import { getManualAlbumById, getAllManualAlbums } from '@/lib/data-loader';
...
// Generate static pages for all manually created albums
export async function generateStaticParams() {
  const albums = await getAllManualAlbums();
